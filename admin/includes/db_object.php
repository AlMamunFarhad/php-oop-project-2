...
class Db_object {
		...
		// $sql .="VALUES ('".$database->escape_string($this->username)."', '".$database->escape_string($this->password) ."', '".$database->escape_string($this->firstname) ."', '".$database->escape_string($this->lastname) ."')";
